 ...
 */
class Parfumcheck extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['submit'] = [
      '#type'  => 'submit',
      '#value' => t('Démarrer la vérification'),
    ];
    return $form;
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $batch = [
      'title'            => t('Vérification des articles parfums ...'),
      'operations'       => [],
      'init_message'     => t('Démarrage de la vérification'),
